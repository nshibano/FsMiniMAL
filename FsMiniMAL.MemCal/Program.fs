...
let main argv =
    ...
    let sizeof_block_len0 = test (fun rt i -> block_create rt 0 (Array.create 0 unit))
    let sizeof_block_len1000 = test (fun rt i -> block_create rt 0 (Array.create 1000 unit))
